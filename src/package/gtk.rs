...
make_meson_packages!(
    ...
    { LibGnomeGamesSupport, "libgnome-games-support", tarball_url = "https://download.gnome.org/sources/libgnome-games-support/2.0/libgnome-games-support-2.0.2.tar.xz", dependencies = [Glib2, Gtk4, LibAdwaita] },
