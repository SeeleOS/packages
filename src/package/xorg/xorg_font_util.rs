...
pub struct XorgFontUtil;

impl Package for XorgFontUtil {
    fn name(&self) -> &'static str { "xorg-font-util" }
...
impl TarballFetch for XorgFontUtil {
    fn tarball_url(&self) -> Vec<&'static str> {
        vec!["https://www.x.org/archive/individual/font/font-util-1.4.1.tar.xz"]
    }
}
