...
pub struct LibFontenc;

impl Package for LibFontenc {
    fn name(&self) -> &'static str { "libfontenc" }
...
impl TarballFetch for LibFontenc {
    fn tarball_url(&self) -> Vec<&'static str> {
        vec!["https://www.x.org/archive/individual/lib/libfontenc-1.1.9.tar.gz"]
    }
}
