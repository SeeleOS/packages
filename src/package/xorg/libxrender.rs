...
pub struct LibXrender;

impl Package for LibXrender {
    fn name(&self) -> &'static str { "libxrender" }
...
impl TarballFetch for LibXrender {
    fn tarball_url(&self) -> Vec<&'static str> {
        vec!["https://www.x.org/archive/individual/lib/libXrender-0.9.12.tar.gz"]
    }
}
