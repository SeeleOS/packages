...
impl Package for LibXdmcp {
    fn name(&self) -> &'static str { "libxdmcp" }
...
impl TarballFetch for LibXdmcp {
    fn tarball_url(&self) -> Vec<&'static str> {
        vec!["https://www.x.org/archive/individual/lib/libXdmcp-1.1.5.tar.gz"]
    }
}
