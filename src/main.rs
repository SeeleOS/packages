...
fn package_by_name(name: &str) -> Option<Box<dyn Package>> {
    match name {
        ...
        "appstream" => Some(Box::new(gtk::AppStream)),
        "cairo" => Some(Box::new(gtk::Cairo)),
        "curl" => Some(Box::new(gtk::Curl)),
        "epoxy" | "libepoxy" => Some(Box::new(gtk::LibEpoxy)),
        "adw" | "libadwaita" => Some(Box::new(gtk::LibAdwaita)),
        "gdk-pixbuf" => Some(Box::new(gtk::GdkPixbuf)),
        "libgnome-games-support" | "games-support" => Some(Box::new(gtk::LibGnomeGamesSupport)),
        "gnome-mines" | "mines" => Some(Box::new(gtk::GnomeMines)),
        "graphene" => Some(Box::new(gtk::Graphene)),
        "gee" | "libgee" => Some(Box::new(gtk::LibGee)),
        "fyaml" | "libfyaml" => Some(Box::new(gtk::LibFyaml)),
        "librsvg" | "rsvg" => Some(Box::new(gtk::Librsvg)),
        "xmlb" | "libxmlb" => Some(Box::new(gtk::LibXmlb)),
